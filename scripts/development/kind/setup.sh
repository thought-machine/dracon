...
DEFINE_string 'kubernetes_version' '1.23' 'Kubernetes version to use' 'k'
FLAGS "$@" || exit $?
eval set -- "${FLAGS_ARGV}"
...
KUBERNETES_VERSIONS=(
  ...
  ["1_23"]="kindest/node:v1.23.12@sha256:9402cf1330bbd3a0d097d2033fa489b2abe40d479cc5ef47d0b6a6960613148a"
)
